...
public class EventSummaryEntity {
	...
	private Double total_vol_hrs;
	@Column(name="total_travel_hrs")
	private Double total_travel_hrs;
	@Column(name="overall_vol_hrs")
	private Double overall_vol_hrs;
	...
	public Double getTotal_vol_hrs() {
		return total_vol_hrs;
	}

	public void setTotal_vol_hrs(Double total_vol_hrs) {
		this.total_vol_hrs = total_vol_hrs;
	}

	public Double getTotal_travel_hrs() {
		return total_travel_hrs;
	}

	public void setTotal_travel_hrs(Double total_travel_hrs) {
		this.total_travel_hrs = total_travel_hrs;
	}

	public Double getOverall_vol_hrs() {
		return overall_vol_hrs;
	}

	public void setOverall_vol_hrs(Double overall_vol_hrs) {
	...
	public EventSummaryEntity(Long id, String event_Id, String poc_Id,
			...
			Double total_vol_hrs, Double total_travel_hrs,
			Double overall_vol_hrs, Integer lives_impact,
