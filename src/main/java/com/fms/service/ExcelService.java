...
public class ExcelService {
	...
	private EventSummaryEntity getEventSummary(Row row) throws ParseException {
	    ...
	    Double totalVolHrs=Double.parseDouble(formatter.formatCellValue(row.getCell(12)));
	    Double totalTravelHrs=Double.parseDouble(formatter.formatCellValue(row.getCell(13)));
	    Double overallVolHrs=Double.parseDouble(formatter.formatCellValue(row.getCell(14)));
